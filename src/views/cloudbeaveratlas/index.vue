 ...
 * @Author: Anybody
 * @LastEditors: Anybody
 * @LastEditTime: 2021-02-02 10:37:22
...
<template>
  <div ref="container" class="container">
    <el-container style="height: 100%">
      <el-aside v-show="asideShow" style="width: 360px">
        ...
        <el-scrollbar>
          <el-collapse v-model="collapseActiveName">
            <el-collapse-item
              v-if="collapseExistName.indexOf('entity') > -1"
              name="entity"
            >
              ...
              <el-col class="collapse-more">
                <el-checkbox v-model="entity.switchStatus">
                  显示空服务类型</el-checkbox
                >
              ...
              <el-col class="collapse-tree">
                ...
                <el-tree
                  ref="entity"
                  v-loading="leftLoading.indexOf('entity') > -1"
                  :data="entity.switchStatus ? entity.data : entity_Active"
                  node-key="name"
                  default-expand-all
                  :highlight-current="entityHighlight"
                  :props="defaultProps"
                  :filter-node-method="filterLeftTreeNode"
                  @node-click="handleNodeClickEntity"
                >
                  <span slot-scope="{ node, data }" class="custom-tree-node">
                    ...
                    <span
                      ...
                      {{
                        data.hasOwnProperty("countActive")
                          ? " (" + data.countActive + ")"
                          : ""
                      }}</span
                    >
            ...
            <el-collapse-item
              v-if="collapseExistName.indexOf('classifications') > -1"
            ...
            >
              ...
              <el-col class="collapse-more">
                <el-checkbox v-model="classifications.switchStatus">
                  显示未使用分类</el-checkbox
                >
                  ...
                  <el-button type="text" size="medium">
                    ...
                    >
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item
                          @click.stop.native="addNewClassification(undefined)"
                        >
                ...
                <el-tooltip content="刷新" placement="top">
                  <el-button
                    ...
                    size="medium"
                    icon="el-icon-refresh"
                    @click="classifications.refreshFun"
                  />
                </el-tooltip>
              </el-col>
              <el-col class="collapse-tree">
                ...
                <el-tree
                  ref="classifications"
                  v-loading="leftLoading.indexOf('classifications') > -1"
                  :data="
                    classifications.switchStatus
                      ? classifications.data
                      : tag_Active
                  "
                  node-key="name"
                  default-expand-all
                  :highlight-current="classificationsHighlight"
                  :props="defaultProps"
                  :filter-node-method="filterLeftTreeNode"
                  @node-click="handleNodeClickClassifications"
                >
                  <span slot-scope="{ node, data }" class="custom-tree-node">
                    <!-- 显示的文字 -->
                    <span
                    ...
                    <span>
                      <el-button
                        v-show="resultQuery.tag === node.label"
                        type="text"
                      >
                        <el-dropdown
                          trigger="click"
                        ...
                        >
                          ...
                          <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item
                              v-if="
                                '_ALL_CLASSIFICATION_TYPES _CLASSIFIED _NOT_CLASSIFIED'.indexOf(
                                  node.label
                                ) <= -1
                              "
                              @click.stop.native="addNewClassification(data)"
                            >
                              <i
                                class="el-icon-plus"
                                style="color: #3d5fff"
                            ...
                            <el-dropdown-item
                              ...
                              "
                              @click.stop.native="gotoViewEdit(data)"
                            >
                              <i
                                class="el-icon-edit"
                                style="color: #3d5fff"
                            ...
                            <el-dropdown-item
                              @click.stop.native="searchClassifications(data)"
                            >
                              <i
            ...
            <el-collapse-item
              v-if="collapseExistName.indexOf('businessMetadata') > -1"
            ...
            >
                ...
                <div style="min-width: 222px">
                    ...
                    <el-button type="text" plain size="medium">
                      ...
                      >
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item
                            @click.native="
                              businessMetadata.showFlat = !businessMetadata.showFlat
                            "
                          >
                            <i
                              :class="{
                                'el-icon-s-operation':
                                  businessMetadata.showFlat,
                                'el-icon-s-grid': !businessMetadata.showFlat,
                              }"
                              style="color: #3d5fff; font-weight: bold"
                            />{{
                              businessMetadata.showFlat
                                ? "Show flat tree"
                                : "Show group tree"
                  ...
                  >
                    <el-button
                      ...
                      plain
                      size="medium"
                      @click="test(businessMetadata.collapseName)"
                    >
                  ...
                  >
                    <el-button
                      ...
                      plain
                      size="medium"
                      @click.stop.native="businessMetadata.refreshFun"
                    >
              ...
              <div style="overflow-y: auto">
                <el-tree
                  ref="businessMetadata"
                  v-loading="leftLoading.indexOf('businessMetadata') > -1"
                  :data="businessMetadata.toShow"
                  default-expand-all
                  :highlight-current="businessMetadataHighlight"
                  :props="defaultProps"
                  :filter-node-method="filterLeftTreeNode"
                  @node-click="handleNodeClickBusinessMetadata"
                />
              </div>
            </el-collapse-item>
            <el-collapse-item
              v-if="collapseExistName.indexOf('glossaries') > -1"
              name="glossaries"
            >
              <div slot="title" class="collapse-title">
                <div style="min-width: 222px">
                    ...
                    <el-button type="text" plain size="medium">
                      ...
                      >
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item
                            @click.native="
                              glossaries.showFlat = !glossaries.showFlat
                            "
                          >
                            <i
                              :class="{
                                'el-icon-s-operation': glossaries.showFlat,
                                'el-icon-s-grid': !glossaries.showFlat,
                              }"
                              style="color: #3d5fff; font-weight: bold"
                            />{{
                              glossaries.showFlat
                  ...
                  >
                    <el-button
                      ...
                      plain
                      size="medium"
                      @click="test(glossaries.collapseName)"
                    >
                      <i class="el-icon-turn-off" style="font-size: 20px" />
                    </el-button>
                  </el-tooltip>
                  ...
                  >
                    <el-button
                      ...
                      plain
                      size="medium"
                      @click.stop.native="glossaries.refreshFun"
                    >
                      <i class="el-icon-refresh" style="font-size: 18px" />
                    </el-button>
                  </el-tooltip>
              ...
              <div style="overflow-y: auto">
                <el-tree
                  ref="glossaries"
                  v-loading="leftLoading.indexOf('glossaries') > -1"
                  :data="glossaries.toShow"
                  default-expand-all
                  :highlight-current="glossariesHighlight"
                  :props="glossariesProps"
                  :filter-node-method="filterLeftTreeNode"
                  @node-click="handleNodeClickGlossaries"
                />
              </div>
            </el-collapse-item>
            <el-collapse-item
              v-if="collapseExistName.indexOf('customFilter') > -1"
              name="customFilter"
            >
              <div slot="title" class="collapse-title">
              ...
              <el-col class="collapse-tree">
                ...
                <el-tree
                  ref="customFilter"
                  v-loading="leftLoading.indexOf('customFilter') > -1"
                  :data="customFilter.data"
                  node-key="searchParameters.guid"
                  default-expand-all
                  :highlight-current="customFilterHighlight"
                  :props="defaultProps"
                  :filter-node-method="filterLeftTreeNode"
                  @node-click="handleNodeClickCustomFilter"
                >
                  <span slot-scope="{ node, data }" class="custom-tree-node">
                    <!-- 显示的文字 -->
                    ...
                    <span>
                      <el-button
                        v-if="
                          node.label !== '高级搜索' && node.label !== '普通搜索'
                        "
      ...
      >
        ...
        <el-button v-show="sliderShow" type="text" @click="resizeAside">
          <svg-icon
            :icon-class="
              asideShow ? 'chevron-circle-left' : 'chevron-circle-right'
            "
          />
        </el-button>
      </span>
      ...
      <el-container>
        ...
        <el-header>
          <Search
            v-if="
              ['atlasResult', 'atlasDetails'].indexOf(this.$route.name) > -1
            "
            style="padding: 24px"
    ...
    <Statistics
      :statistics-show="statisticsShow"
      @closestatistics="statisticsShow = false"
    />
    <el-dialog
      width="40%"
      :visible.sync="filterRenameShow"
      title="重命名自定义过滤器"
      @close="
        () => {
          this.$refs.filterInfo.resetFields();
        }
      "
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" type="primary" @click="filterRenameShow = false"
          >关 闭</el-button
        >
        <el-button
          v-loading="isLoading"
          size="small"
          type="primary"
          @click="submitFilterName('filterInfo')"
          >更 新</el-button
        >
      </div>
    </el-dialog>
    <el-dialog
      width="40%"
      :visible.sync="filterDeleteShow"
      title="删除自定义过滤器"
      @close="filterDeleteShow = false"
    >
      <el-form>
        <el-form-item>
      ...
      <el-divider />
      <div slot="footer" class="dialog-footer">
        <el-button size="small" type="primary" @click="filterDeleteShow = false"
          >关 闭</el-button
        >
        <el-button
          v-loading="isLoading"
    ...
    <el-dialog
      width="40%"
      :visible.sync="classificationDeleteShow"
      title="删除分类"
      @close="classificationDeleteShow = false"
    >
      <el-form>
        <el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          size="small"
          type="primary"
          @click="classificationDeleteShow = false"
          >关 闭</el-button
        >
        <el-button
          v-loading="isLoading"
...
export default {
  ...
  computed: {
    ...
    // entity有值项
    entity_Active() {
      return this.entity.data.filter((item) => {
        if (
          this.entityActiveList.hasOwnProperty(item.name) &&
          "path type db column table instance".indexOf(
    ...
    tag_Active() {
      return this.classifications.data.filter((item) => {
  ...
  methods: {
    ...
    handleNodeClickEntity(data) {
      ...
      this.resultQuery.type =
        this.resultQuery.type === data.name ? null : data.name;
    ...
    handleNodeClickClassifications(data) {
      this.resultQuery.searchType = "basic";
      this.resultQuery.tag =
        this.resultQuery.tag === data.name ? null : data.name;
      this.resultQuery.attributes = null;
      var tempQuery = {};
      for (var i in this.resultQuery) {
        if (this.resultQuery[i] !== null) {
    ...
    handleNodeClickCustomFilter(data) {
      ...
      this.resultQuery.type = !data.searchParameters.hasOwnProperty("typeName")
        ...
        : (this.resultQuery.type =
            this.resultQuery.type === data.searchParameters.typeName
              ? null
              : data.searchParameters.typeName);
      this.resultQuery.tag = !data.searchParameters.hasOwnProperty(
        "classification"
      )
        ? null
        : (this.resultQuery.tag =
            this.resultQuery.tag === data.searchParameters.classification
              ? null
              : data.searchParameters.classification);
    ...
    async loadListEntities() {
      this.loadLeftListNotEmptyNameList();
      ...
      if (res.status === 200 && res.statusText === "OK") {
        ...
        for (const i in this.notEmptyList.entity.entityDeleted) {
          this.entityActiveList[i] = this.entityActiveList.hasOwnProperty(i)
            ? this.entityActiveList[i] +
              this.notEmptyList.entity.entityDeleted[i]
            : this.notEmptyList.entity.entityDeleted[i];
        }
        for (const i in this.notEmptyList.entity.entityShell) {
          this.entityActiveList[i] = this.entityActiveList.hasOwnProperty(i)
            ? this.entityActiveList[i] + this.notEmptyList.entity.entityShell[i]
            : this.notEmptyList.entity.entityShell[i];
        }
      } else {
        this.$message({
          message: "获取实体列表失败",
      ...
      if (res.status === 200 && res.statusText === "OK") {
        ...
        for (var i in this.glossaries.toShow) {
          for (var k in this.glossaries.toShow[i].terms) {
            this.glossaries.toShow[i].terms[k].name = this.glossaries.toShow[
              i
            ].terms[k].displayText;
            this.glossaries.toShow[i].terms[
              k
            ].fathername = this.glossaries.toShow[i].name;
          }
        }
      } else {
        this.$message({
    ...
    async deleteFilter() {
      this.isLoading = true;
      const res = await apiatlas.deleteCustomFilters(
        this.filterInfo.filterInfos
      );
      // console.log(res);
      if (res.status === 204) {
        this.$message({
    ...
    async deleteNewClassification() {
      this.isLoading = true;
      const res = await apiatlas.deleteNewClassification(
        this.classificationToDelete.description
      );
      if (res.status === 204) {
        this.$message({
          message: "删除成功",
