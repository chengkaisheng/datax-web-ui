      ...
      <div class="part-container">
        ...
        >
          ...
          >
            ...
            />
            <span v-else>{{
              writerFormQuality.hiveWriter.writerDefaultFS
            }}</span>
          </el-form-item>
          <el-form-item
            v-if="dataSource === 'hive'"
          ...
          >
            ...
            />
            <span v-else>{{
              writerFormQuality.hiveWriter.writerFileName
            }}</span>
          </el-form-item>
          <el-form-item
            v-if="dataSource === 'hive'"
          ...
          >
            ...
            />
            <span v-else>{{
              dashOrValue(writerFormQuality.hiveWriter.writeFieldDelimiter)
            }}</span>
          </el-form-item>
