<template>
  <div class="interlayer-content">
    ...
    <el-row v-show="moreStatus=='up'" style="width: 100%; margin-top: 15px;">
      业务过程：
      <el-select v-model="business" style="margin-right: 20px;" placeholder="请选择">
        <el-option
          v-for="item in businessListe"
          :key="item.liste"
          :label="item.label"
          :value="item.liste"
        ></el-option>
    ...
    <el-dialog title="新建维度" :visible.sync="information" width="35%">
      <el-form :model="form" label-width="80px" style="width: 80%;">
        ...
        <el-row style="font-size: 14px; margin-bottom:20px" :label-width="formLabelWidth">
          <el-col :span="7" align="end">业务过程：</el-col>
          <el-col :span="7">充值</el-col>
        </el-row>
        <el-row style="font-size: 14px; margin-bottom:20px" :label-width="formLabelWidth">
    ...
    <!-- 新建原子词弹窗 -->
    <el-dialog title="新建原子词" :visible.sync="NewAtomicWord" width="35%">
      <el-form :model="form" label-width="80px" style="width: 90%;">
        ...
        <el-form-item label="业务过程：" :label-width="formLabelWidth">
          <el-input v-model="form.name" autocomplete="off" placeholder="可选，请搜索选择业务过程"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="NewAtomicWord = false">取 消</el-button>
        <el-button type="primary" @click="NewAtomicWord = false">确 定</el-button>
      </div>
    </el-dialog>

    <div>
      <div class="table-button">
        <el-button size="small" type="primary" @click="NewAtomicWord= true">+ 新建原子词</el-button>
      </div>
      <el-row class="el-row-style">
        <el-table :data="tableData" :header-cell-style="{background:'#fafafa'}">
          <el-table-column type="selection"></el-table-column>
          <el-table-column prop="name" label="显示名" width="120" header-align="left" align="left">
            <template>
              <el-button type="text" @click="information = true">累计充值金额</el-button>
            </template>
          </el-table-column>
          <el-table-column
            prop="subject"
          ...
          <el-table-column
            ...
            align="center"
          ></el-table-column>
          <el-table-column prop="status" label="状态" width="80" header-align="center" align="center"></el-table-column>
      ...
      <br />
      <!-- 修改弹窗 -->
      <el-dialog title="编辑原子词" :visible.sync="modification" width="35%">
        <el-form :model="form" label-width="80px" style="width: 90%;">
          <el-form-item label="主题域：" :label-width="formLabelWidth">
            <el-select v-model="form.region" placeholder="请选择" style="width:100%;">
          ...
          <el-form-item label="显示名：" :label-width="formLabelWidth">
            <el-input v-model="form.name" autocomplete="off" placeholder="累计充值金额"></el-input>
          </el-form-item>
          <el-form-item label="业务过程：" :label-width="formLabelWidth">
            <!-- <el-input v-model="form.name" autocomplete="off" placeholder="可选，请搜索选择业务过程"></el-input> -->
          ...
          <el-form-item label="业务口经" :label-width="formLabelWidth">
            <el-input v-model="form.name" autocomplete="off" type="textarea" placeholder="累计充值金额"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
      ...
      <div>
        ...
        <el-dropdown trigger="click">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>批量修改负责人</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
      <el-pagination
