      ...
      <el-tab-pane label="域列表" name="first">
        ...
        <div>
          ...
          <el-row class="el-row-style">
            <el-table :data="tableData1" :header-cell-style="{background:'#fafafa'}">
              <!-- <el-table-column
                            type="selection"
                            >
              </el-table-column>-->
              ...
              <el-table-column fixed="right" label="操作" header-align="center" align="center">
                <template>
                  <el-button type="text" @click="$router.push('')">管理</el-button>
                  <i class="wire"></i>
          ...
          <div class="table-button">
            ...
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>新增资产准入规范</el-dropdown-item>
                <el-dropdown-item>新增资产设计规范</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
          <el-row class="el-row-style">
